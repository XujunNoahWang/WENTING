...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      'react-native-sqlite-storage': path.resolve(__dirname, 'src/utils/mocks/SQLiteStorage.web.ts'),
      'react-native-touch-id': path.resolve(__dirname, 'src/utils/mocks/TouchID.web.ts'),
      'react-native-encrypted-storage': path.resolve(__dirname, 'src/utils/mocks/EncryptedStorage.web.ts'),
      'react-native-vector-icons/Ionicons': path.resolve(__dirname, 'src/utils/mocks/VectorIcons.web.tsx'),
      '@react-native-google-signin/google-signin': path.resolve(__dirname, 'src/utils/mocks/GoogleSignin.web.ts'),
      '@react-native-firebase/auth': path.resolve(__dirname, 'src/utils/mocks/FirebaseAuth.web.ts'),
      '@react-native-firebase/app': path.resolve(__dirname, 'src/utils/mocks/FirebaseApp.web.ts'),
      '@react-native-firebase/firestore': path.resolve(__dirname, 'src/utils/mocks/FirebaseFirestore.web.ts'),
